...
const Reports = (props) => { // Notice the arrow function... regular function()  works too
                                    ...
                                    <Card raised={true}>
                                        <Box mx={1} my={1} boxShadow={0}>
                                            <Grid
                                                ...
                                                spacing={1}
                                            >
                                                {(reportsData && Object.keys(reportsData).length != 0 && Object.getPrototypeOf(reportsData) === Object.prototype)? (
                                                    <>
                                                        <Grid item xs={12}>
                                                        ...
                                                        <Grid item xs={12} id="dashboard">
                                                            ...
                                                            <ReportDashboard reports = {reportsData} collection = {currentReportIndex}></ReportDashboard>
                                                        </Grid>
                                                        ...
                                                        <Grid item xs={12} id="summary">
                                                            ...
                                                            <Summary reports = {reportsData} collection = {currentReportIndex}/>             
                                                        </Grid>
                                                        ...
                                                        <Grid item xs={12} id="possible concerns">
                                                            ...
                                                            <PossibleConcerns  reports = {reportsData} collection = {currentReportIndex}/>             
                                                        </Grid>
                                                        ...
                                                        <Grid item xs={12} id="suggestions">
                                                            ...
                                                            <Suggestions  reports = {reportsData} collection = {currentReportIndex}/>             
                                                        </Grid>
                                                    </>
                                                ) : (
                                                    <>
