...
export default function CollectionTable(props) {
  ...
  // Variables ===
        ...
        const { appState, isDense, userID, searchFilteredDataList, setParentDeleteCollectionDialog, setParentExportCollectionDialog,
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            {userID? (
                                                ...
                                                <>
                                                    <TableCell align="left" padding="none">
                                                        <Typography color="secondary" variant="body2" style={{display: 'inline-block'}}>
                                                            {item.patientName}
                                                        </Typography>
                                                    </TableCell>
                                            ...
                                            <TableCell align="right" padding="normal">
                                                <Tooltip title={
                                                    <>
                                                        <Typography color="inherit">Chapter Templates</Typography>
                                                        <ol>
                                                            {item.chapterTemplates.map((subItem, index) => {
                                                                return (
                                                        ...
                                                        <em>{"Public templates that this"}</em> <b>{'collection'}</b> <u>{'is created from'}</u>.{' '}
                                                    </>
                                                } placement="top">
                                                    <Button>
                                                        <Typography color="secondary" variant="body2" style={{display: 'inline-block'}}>
                                                            {item.memberChapters.length}
                                                        </Typography>
                                                    </Button>
                                                </Tooltip>
                                            </TableCell>
